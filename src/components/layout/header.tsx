  ...
  return (
    <header
      className={cn(
        ...
        "md:inset-x-3 md:top-3 md:w-[calc(100%-1.5rem)] md:rounded-2xl",
        scrolled
          ? "bg-background/95 backdrop-blur-xl shadow-xl shadow-black/[0.08] md:border md:border-border/40"
          : "bg-background/90 backdrop-blur-md md:border md:border-border/20",
      )}
    >
      <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3 relative z-10">
          <Image
            ...
            priority
          />
          <span className="max-[1200px]:hidden border-l border-black/15 pl-3 text-[0.85rem] font-semibold tracking-wide text-black/70 whitespace-nowrap">
            {SITE_CONFIG.slogan}
          </span>
        </Link>
        ...
        <button
          type="button"
          className="inline-flex items-center justify-center rounded-lg p-2 text-black/60 hover:bg-muted hover:text-black md:hidden relative z-10"
        ...
        {isMobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-16 right-0 z-50 w-full max-w-sm border-l border-border/30 bg-background/95 backdrop-blur-xl md:hidden"
            >
              <nav
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            isActive
                              ...
                              : "text-black/60 hover:bg-muted hover:text-black",
                          )}
                          onClick={() =>
                            setOpenDropdown(
